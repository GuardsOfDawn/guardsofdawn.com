...
<div id="menu"><?php wp_nav_menu( array( 'theme_location' => 'mainmenu', 'menu_class' => 'dropdown dropdown-horizontal','fallback_cb'     => 'Destro_backupmenu', 'menu_id'=>'Main_nav', 'container'=>'') ); ?></div>
										...
										<?php if (have_posts()) : ?>
											<?php $count = 0; while (have_posts()) : the_post(); $count++; ?>
												...
												<div <?php post_class('actual_post') ?> id="post-<?php the_ID(); ?>">
													...
													<div class="metadata">
														<!--<p>
															<span class="label"><?php _e('Раздел:', 'Destro') ?></span>
