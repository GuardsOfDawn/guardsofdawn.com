										...
										<div <?php post_class($pcont) ?> id="post-<?php the_ID(); ?>">
											...
											<div class="mag_two_post_excerpt">
												...
												<div class="mag_two_post_excerpt_p">
                                                    ...
                                                    <p class="mag_post_excerpt_more"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'Destro' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">Подробнее</a></p>  
                                                </div>
											</div>																						
